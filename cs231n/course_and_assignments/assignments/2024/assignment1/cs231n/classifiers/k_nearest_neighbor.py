...
class KNearestNeighbor(object):
    ...
    def compute_distances_two_loops(self, X):
        ...
        for i in range(num_test):
            for j in range(num_train):
                ...
                def l2(a, b):
                    diff = a - b
                    result = diff.T.dot(diff)
                    return math.sqrt(result)

                dists[i, j] = l2(self.X_train[j], X[i])
    ...
    def compute_distances_one_loop(self, X):
        ...
        for i in range(num_test):
            ...
            #######################################################################
            # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
#            t = np.tile(X[i], (num_train, 1))
            dis = self.X_train - X[i]
            element_wise_dot = dis * dis
            
            dists[i] = np.sqrt(np.sum(element_wise_dot, axis =1))
...
#            print("closest:", closest_indices)
            for ci in closest_indices:
#                print("ci:", ci)
                closest_y.append(self.y_train[ci])
#            print("closest Y:", closest_y)
            ...
            #########################################################################
            # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            most_occurrent_y = np.bincount(closest_y).argmax()
#            print("y label:", most_occurrent_y)
            y_pred[i] = most_occurrent_y
