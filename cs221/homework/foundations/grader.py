...
grader.add_basic_part('4b-1-hidden', test4b1, max_points=2, description='100 random trials')
...
grader.add_basic_part('4c-1-hidden', test4c1, max_points=2, description='random trials')
...
grader.add_basic_part('4c-2-hidden', test4c2, max_points=3, description='random trials (bigger)')
...
grader.add_basic_part('4d-1-hidden', test4d1, max_points=3, description='random trials')
...
grader.add_basic_part('4e-1-hidden', test4e1, max_points=3, description='random trials')
...
grader.add_basic_part('4f-1-hidden', lambda: test4f12(1000, 10), max_points=1, description='random trials')
grader.add_basic_part('4f-2-hidden', lambda: test4f12(10000, 100), max_points=2, description='random trials (bigger)')
